...
import { defaultTheme, LOCAL_STORAGE_THEME_KEY, Theme, ThemeContextType } from '../../../types/ThemeTypes';
...
export const ThemeProvider: FC = ({ children }) => {
	...
	const initialValue: ThemeContextType = React.useMemo(() => ({ theme, setTheme }), [theme, setTheme]);
